...
public interface ScoringKafkaMessageMappingStrategy {
     ...
     * - LoanScoringKafkaMessageMappingStrategy (ScoringGenerationDTO) → LoanScoringPayloadDTO
     * - CreditCardScoringKafkaMessageMappingStrategy (CreditCardScoringGenerationDTO) → CreditCardScoringPayloadDTO
     *
     * @param message the Kafka message (will be cast to expected type by implementation)
